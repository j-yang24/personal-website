...
const BlogPage = () => (
    ...
    <h1 className={styles.header1}>Death isn't the only goodbye in this life</h1>
    <h2 className={styles.header2}>A reflection on my college experience</h2>
...
export const Head = () => <Seo title="college" />;
